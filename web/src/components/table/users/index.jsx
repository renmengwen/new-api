...
const UsersPage = ({ mode = 'legacy', capabilities = {} }) => {
  ...
  const effectiveCapabilities = isManagedMode
    ? {
        ...
        canResetPasskey: capabilities.canResetPasskey === true,
        canResetTwoFA: capabilities.canResetTwoFA === true,
        canManageSubscriptions: capabilities.canManageSubscriptions === true,
        canManageBindings: capabilities.canManageBindings === true,
