...
const AdminUserPermissionsCleanPage = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        dataIndex: 'user_type',
        width: 120,
        render: (value) => <Tag color='blue'>{t(getUserTypeText(value))}</Tag>,
      },
      {
        title: t('绑定模板'),
            ...
            <div style={sectionStyle}>
              ...
              <Select
                ...
                optionList={[
                  ...
                  ...filterTemplateOptions(templates, editingUser),
                ]}
...
export default AdminUserPermissionsCleanPage;
