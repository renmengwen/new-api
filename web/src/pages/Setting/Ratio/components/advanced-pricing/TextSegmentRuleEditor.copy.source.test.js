...
test('text segment rule editor adds a copy action that opens a new draft with max priority plus one', () => {
  assert.match(
    source,
  ...
  assert.match(source, /createEmptyTextSegmentRule\(Date\.now\(\)\)\.id/);
