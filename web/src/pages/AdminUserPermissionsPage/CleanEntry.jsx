...
import AdminUserPermissionsCleanPage from '../AdminUserPermissionsPageV3/CleanPage';

const { Text } = Typography;

const AdminUserPermissionsPageCleanEntry = () => {
  ...
  return <AdminUserPermissionsCleanPage />;
};

export default AdminUserPermissionsPageCleanEntry;
