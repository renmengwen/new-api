...
func setupRewardLedgerTables(t *testing.T) {
	t.Helper()
	require.NoError(t, DB.AutoMigrate(&User{}, &Log{}, &QuotaAccount{}, &QuotaLedger{}, &Checkin{}))
	t.Cleanup(func() {
...
func TestInsertCreatesRewardLedgersForRegisterAndInviteBonus(t *testing.T) {
	setupRewardLedgerTables(t)
...
func TestFinalizeOAuthUserCreationCreatesRewardLedgers(t *testing.T) {
	setupRewardLedgerTables(t)
